...
import "./toolbar.css";
const EditorToolbar = () => {
  const { editorState, setEditorState, toggleInlineStyle, toggleFontSize } =
    ...
    <div className="w-full h-9 px-3 py-1 flex-shrink-0 flex items-center">
      ...
      <div className="toolbar">
        ...
        <button
          onMouseDown={(e) => {
            e.preventDefault();
            toggleFontSize(FONT_SIZES.SMALL);
          }}
        >
        ...
        <button
          onMouseDown={(e) => {
            e.preventDefault();
            toggleFontSize(FONT_SIZES.MEDIUM);
          }}
        >
        ...
        <button
          onMouseDown={(e) => {
            e.preventDefault();
            toggleFontSize(FONT_SIZES.LARGE);
          }}
        >
