...
class AuthController {
    constructor() {
        this.login = (0, catch_async_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!validPassword) {
                return res.status(401).json({ erros: responses_1.userNotFound });
            }
            // if (!user.isVerified) {
        ...
        this.refreshToken = (0, catch_async_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield jsonwebtoken_1.default.verify(refreshToken, "refresh_token", (error, decoded) => __awaiter(this, void 0, void 0, function* () {
                if (error)
                    return res.status(403);
                try {
