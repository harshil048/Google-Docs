...
class UserController {
    constructor() {
        ...
        this.getUser = (0, catch_async_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const user = user_service_1.userService.findUserById(userId);
            if (user === null) {
        ...
        this.confirmResetPassword = (0, catch_async_1.default)((req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            jsonwebtoken_1.default.verify(resetPasswordToken, "reset_Password", (err, decoded) => __awaiter(this, void 0, void 0, function* () {
                if (err)
                    return res.sendStatus(403);
                try {
                    const { email } = decoded;
